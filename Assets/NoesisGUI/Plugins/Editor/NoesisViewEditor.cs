...
public class NoesisViewEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        view._enableKeyboard = EditorGUILayout.Toggle(new GUIContent("Enable Keyboard",
            "Indicates if keyboard input events are processed by this view"),
            view._enableKeyboard);

        view._enableMouse = EditorGUILayout.Toggle(new GUIContent("Enable Mouse",
            "Indicates if mouse input events are processed by this view"),
            view._enableMouse);

        view._enableTouch = EditorGUILayout.Toggle(new GUIContent("Enable Touch",
            "Indicates if touch input events are processed by this view"),
            view._enableTouch);

        view._enableGamepad = EditorGUILayout.Toggle(new GUIContent("Enable Gamepad",
            "Indicates if gamepad input events are processed by this view"),
            view._enableGamepad);
        ...
        view._useRealTimeClock = EditorGUILayout.Toggle(new GUIContent("Real Time Clock",
            "Indicates if 'Time.realtimeSinceStartup' is used instead of 'Time.time' for animations"),
